...
namespace ConsoleApp1
{
    public class Address
    {
        ...
        public void ParseAddress(string fullAddress, string countryId)
        {
            ...
            string normalizedAddress = TextNormalizer.NormalizeAddress(fullAddress.ToUpperInvariant().Replace(",", " ").Trim());
            ...
            {
                string newNormalizedAddress = TextNormalizer.NormalizeAddress(fullAddress.ToUpperInvariant().Replace(",", " ").Trim());
